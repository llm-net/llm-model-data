...
每家一个目录，产品与价格独立。下面是本次初始化范围，不是全行业完整清单；未列出的国际站和订阅产品可以按相同结构添加。

| 服务商 | 产品 |
| --- | --- |
| [晨羽 AI](chenyu-ai/README.md) | api |
| [DeepSeek](deepseek/README.md) | api-cn |
| [火山方舟](ark/README.md) | api-cn, agent-plan-cn, coding-plan-cn |
| [阿里云百炼](bailian/README.md) | api-cn, token-plan-cn, coding-plan-cn |
...
| [OpenAI](openai/README.md) | api-global, codex |
| [Anthropic](anthropic/README.md) | api-global, claude-code |
| [Google Gemini](gemini/README.md) | api-global |
| [xAI](xai/README.md) | api-global, grok-build |
